...
const SearchForm = ({ filters, setFilters, onSearch, savedQueries, addSavedQuery, removeSavedQuery }) => {
  ...
  // Варианты градиента (сверху вниз, от тёмного к светлому):
  // 1. from-indigo-900 to-indigo-500
  // 2. from-purple-900 to-purple-500
  // 3. from-slate-800 to-slate-500
  // 4. from-gray-900 to-gray-600
  // 5. from-blue-900 to-blue-600
