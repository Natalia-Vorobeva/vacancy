...
const SearchForm = ({
  ...
  // Синхронизация с пропсами (если они изменились извне, например, при выборе сохранённого запроса)
  useEffect(() => {
  ...
  return (
    <div className="shadow-[0_15px_30px_-12px_rgba(0,0,0,0.2)] p-4 mb-6">
      <form onSubmit={handleSubmit}>
        ...
        {/* Поле исключения слов – отдельный блок, не внутри grid */}
        <div className="mt-4">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 text-sm">
            <span className="text-gray-700 whitespace-nowrap">Исключить слова в названии (через запятую):</span>
            <input
              type="text"
