  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        {/* Левая колонка: номер, название, компания */}
        ...
        <div className="text-right text-sm text-gray-500">
          ...
          {/* Звёзды рейтинга перенесены сюда */}
      ...
      {/* Блок навыков – теперь выводятся все, с нижней границей */}
      ...
      {/* Нижняя строка: кнопка избранного, иконка модалки, корзина */}
